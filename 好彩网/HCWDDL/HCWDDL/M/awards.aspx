...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <section class="tabContainer">
        <div class="con kjList bg-fff active">
            ...
            <a class="ticket ub ub-ac" href="/M/awarddetail/award_dlt.aspx?id=<%=DLTInfo.id %>">
                <div class="ub-f1 mr-10">
            ...
            <a class="ticket ub ub-ac" href="/M/awarddetail/award_p3.aspx?id=<%=P3Info.id %>">
                <div class="ub-f1 mr-10">
            ...
            <a class="ticket ub ub-ac" href="/M/awarddetail/award_qxc.aspx?id=<%=QXCInfo.id %>">
                <div class="ub-f1 mr-10">
            ...
            <a class="ticket ub ub-ac" href="/M/awarddetail/award_qlc.aspx?id=<%=QLCInfo.id %>">
                <div class="ub-f1 mr-10">
