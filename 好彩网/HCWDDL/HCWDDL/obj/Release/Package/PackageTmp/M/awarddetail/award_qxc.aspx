<%@ Page Title="" Language="C#" MasterPageFile="~/M/Index.Master" AutoEventWireup="true" CodeBehind="award_qxc.aspx.cs" Inherits="HCWDDL.M.awarddetail.award_qxc" %>
        ...
        <div class="content">
            ...
            <div class="chooseQi clearfix">
                <%foreach (var qi in DIC_QI)
                  { %>
                <div class="con">
                    <a target="_self" href="award_qxc.aspx?id=<%=qi.id %>"><%=qi.qi %></a>
                </div>
                <%} %>
            </div>
        </div>
            ...
            <div class="ticket">
                <div>
                    <div class="name ub ub-ac">
                        <div class="ub-f1">
                            <b class="text-16 mr-10">七星彩 <%=Model.qi.HasValue?Model.qi.Value.ToString().Substring(4,3):"" %> 期开奖</b>
