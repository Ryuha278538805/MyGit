<%@ Page Title="" Language="C#" MasterPageFile="~/M/Index.Master" AutoEventWireup="true" CodeBehind="award_qlc.aspx.cs" Inherits="HCWDDL.M.awarddetail.award_qlc" %>
        ...
        <div class="content">
            ...
            <div class="chooseQi clearfix">
                <%foreach (var qi in DIC_QI)
                  { %>
                <div class="con">
                    <a target="_self" href="award_qlc.aspx?id=<%=qi.id %>"><%=qi.qi %></a>
                </div>
                <%} %>
            </div>
        </div>
            ...
            <div class="ticket">
                <div>
                    <div class="name ub ub-ac">
                        <div class="ub-f1">
                            <b class="text-16 mr-10">七乐彩 <%=Model.qi.HasValue?Model.qi.Value.ToString().Substring(4,3):"" %> 期开奖</b>
                    ...
                    <div class="ub ub-ac">
                        <div class="ballBox ub-f1">
                            ...
                            <span class="ball red"><%=Model.f.HasValue? Model.f.Value.ToString():"" %></span>
                            <span class="ball red"><%=Model.g.HasValue? Model.g.Value.ToString():"" %></span>
                            <span class="ball blue"><%=Model.h.HasValue? Model.h.Value.ToString():"" %></span>
                        </div>
                    </div>
        ...
        <div class="p-10">
            <table class="kjTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>七等奖</td>
                        <td><%=Model.GetJCMoney(Model.zj7).ToString("N0") %></td>
                        <td></td>
                    </tr>
                </tbody>
            </table>
