<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templet_add.aspx.cs" Inherits="Admin.templet_add" %>
	...
	<div class="clear"></div> <!-- End .clear -->
				  ...
				  <div class="tab-content default-tab" id="tab1">
						   ...
						   <tr>
                            ...
                            <td>
                            	...
                            	<asp:DropDownList ID="czid" runat="server" CssClass="select"><asp:ListItem Text="==请选择彩种==" Value="0"></asp:ListItem></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;
                             	&nbsp;
                            ...
                            <td><asp:DropDownList ID="zid" runat="server" CssClass="select"><asp:ListItem Text="==请选择专题==" Value="0"></asp:ListItem></asp:DropDownList>                                
                                <asp:RadioButtonList ID="zidrbt" runat="server" RepeatLayout="UnorderedList"></asp:RadioButtonList>
                                </td>
                            </tr>
						  <tr>
	  ...
	  <input type="hidden" id="color" name="color" value="<%=color%>" /></td>
						  ...
						  <tr>
                            ...
                            <td><ul class="tmlist"><%=templetabout%></ul></td>
                            </tr>
						  <tr>
                            <td valign="top"><label>模板内容*</label></td>
