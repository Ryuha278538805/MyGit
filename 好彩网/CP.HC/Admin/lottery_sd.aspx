<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lottery_sd.aspx.cs" Inherits="Admin.lottery_sd" %>
...
<div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <h2>添加/编辑福彩3D开奖号
              ...
              &nbsp;<asp:Button ID="autoget" Text=" 收录新开奖号 "  CssClass="button" runat="server" OnClick="autoget_Click"/></h2>
            <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>添加/编辑框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">福彩3D开奖号添加/编辑</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
							...
							<div class="tab-content default-tab" id="tab1">
							  ...
							  <table>
                                <tbody>
                                 <tr>
                                    <td width="15%"><p>
                                      <label>期号+开机号*</label></p></td>
                                    <td width="63%"><asp:TextBox ID="qi" runat="server" CssClass="text-input" Width="100px"></asp:TextBox> <asp:TextBox ID="kjih" runat="server" CssClass="text-input" Width="100px"></asp:TextBox></td>
                                    <td width="22%"><span class="tip">(期号和开机号)</span></td>
                                 </tr>
                                 <tr>
                                    <td><p>
              ...
              <asp:TextBox ID="c" runat="server" CssClass="text-input" Width="20px"></asp:TextBox></td>
                                    <td><span class="tip">(开奖号)</span></td>
                                  </tr>
                                  <tr>
                                    <td><p>
                                      <label>中奖数*</label></p></td>
                                    <td><asp:TextBox ID="zj1" runat="server" CssClass="text-input" Width="100px"></asp:TextBox>
                                   ...
                                   <tr>
                                    <td><p>
                                      <label>试机号*</label></p></td>
                                    <td><asp:TextBox ID="sjh" runat="server" CssClass="text-input" Width="100px"></asp:TextBox> 
                                    <asp:DropDownList ID="sjx" runat="server" CssClass="select">
                                      <asp:ListItem Text="==请选择类型==" Value="0"></asp:ListItem>
                                      <asp:ListItem Text="1机1球" Value="1机1球"></asp:ListItem>
                                      <asp:ListItem Text="1机2球" Value="1机2球"></asp:ListItem>
                                      <asp:ListItem Text="2机1球" Value="2机1球"></asp:ListItem>
                                      <asp:ListItem Text="2机2球" Value="2机2球"></asp:ListItem>
                                    </asp:DropDownList></td>
	  ...
	  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>列表框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">福彩3D开奖号</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
							  ...
							  <table>
							    <thead>
							      <tr>
                                    ...
                                    <th width="13%">试机类型</th>
                                    <th width="14%">投注额</th>
                                    <th width="16%"><span class="tip">直选/组3/组6</span></th>
                                    <th width="12%">开奖日期</th>
							        <th width="10%">操作</th>
						          </tr>
						        </thead>
							      ...
							      <asp:Repeater ID="list" runat="server" EnableViewState="true">
							        <itemtemplate>
							          <tr>
							            ...
							            <td class="red"><%#GetKjh(DataBinder.Eval(Container.DataItem,"kjh"))%></td>
                                        <td><%#GetKjh(DataBinder.Eval(Container.DataItem,"sjh"))%></td>
                                        <td><%#DataBinder.Eval(Container.DataItem,"sjx")%></td>
							            <td><%#DataBinder.Eval(Container.DataItem,"tzmoney").ToString().Trim()%></td>
                                        <td><%#DataBinder.Eval(Container.DataItem,"zj1").ToString().Trim()%> / <%#DataBinder.Eval(Container.DataItem,"zj2").ToString().Trim()%> / <%#DataBinder.Eval(Container.DataItem,"zj3").ToString().Trim()%></td>
