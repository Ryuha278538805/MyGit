<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lottery_ssq.aspx.cs" Inherits="Admin.lottery_ssq" %>
				...
				<div class="content-box-header">
				  ...
				  <h3>添加/编辑框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">双色球开奖号添加/编辑</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
              ...
              <asp:TextBox ID="g" runat="server" CssClass="text-input" Width="20px"></asp:TextBox></td>
                                  ...
                                  <tr>
                                    ...
                                    <td>一等：
                                      ...
                                      六等：
                                      <asp:TextBox ID="zj6" runat="server" CssClass="text-input" Width="100px"></asp:TextBox></td>
                                   ...
                                   <tr>
                                    ...
                                    <td>一等：
                                      ...
                                      二等：
                                      <asp:TextBox ID="jo2" runat="server" CssClass="text-input" Width="100px"></asp:TextBox></td>
                                  ...
                                  <tr>
                                    <td><p>
                                      <label>地区详情说明</label></p></td>
                                    <td><asp:TextBox ID="cc" runat="server" CssClass="text-input" Width="220px"></asp:TextBox></td>
                                    <td><span class="tip">(地区详情说明)</span></td>
                                  </tr>
                                   <tr>
                                    <td><p>
	  ...
	  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>列表框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">双色球开奖号</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
							      ...
							      <asp:Repeater ID="list" runat="server" EnableViewState="true">
							        <itemtemplate>
							          <tr>
							            ...
							            <td><span class="red"><%#GetKjh(DataBinder.Eval(Container.DataItem,"a"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"b"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"c"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"d"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"e"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"f"))%></span>&nbsp;&nbsp;|&nbsp;&nbsp;<span class="blue"><%#GetKjh(DataBinder.Eval(Container.DataItem,"g"))%></span></td>
