...
namespace Admin
{
    public partial class templet_list : Pages
    {
        ...
        private void BinderList()
        {
            ...
            DataSet ds = NewsTempletData.GetPageList(AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex, "tbl_news_templet", "tid desc", where);
