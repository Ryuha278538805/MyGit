...
namespace Common
{
    ...
    {    /// <summary>
        ...
        /// 表示 base 24 编码
            ...
            private static Base24 defaultInstance;
            ...
            {
                return GetString(System.Text.Encoding.UTF8.GetBytes(text));
            }
            ...
            {
                return System.Text.Encoding.UTF8.GetString(GetBytes(code));
            }
