...
namespace Common
{
    ...
    public class Avatars
    {
        ...
        private static string forumPath = "http://bbs.haocw.com/";
        /// <summary>
        /// 获取头像地址
        /// </summary>
        ...
        public static string GetAvatarUrl(string uid, AvatarSize avatarSize)
        {
            ...
            string physicsAvatarPath = string.Format(AVATAR_URL, uid.Substring(0, 3), uid.Substring(3, 2), uid.Substring(5, 2), uid.Substring(7, 2), size);            
             return forumPath + "avatars/" + physicsAvatarPath;
        }
        ...
        {
            return  forumPath + "images/common/noavatar_" + avatarSize.ToString().ToLower() + ".gif";
        }
