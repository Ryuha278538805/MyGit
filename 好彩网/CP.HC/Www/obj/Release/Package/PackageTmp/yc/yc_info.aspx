...
<title>福彩三D预测\<%=info.title%>\<%=yzinfo.name%>\好彩网</title>
...
<div class="w1200" >
	...
	<div class="left">
		...
		<div class="title1"><h1><%=info.title%>好彩网发布</h1></div>
...
.ss1 p {
	color: #fff;width:300px;font-size: 14px;background-color: #000; filter:alpha(opacity=50);
      -moz-opacity:0.5;  
      -khtml-opacity: 0.5;  
      opacity: 0.5;  
}
...
<span >
		...
		<br />
		标签：<a href="/dsyc/list_<%=info.yzid%>_1.html"><%=yzinfo.name%></a><br /><br />
	...
	<div style="margin-left:15px;float:left;width:378px;"><script type="text/javascript" src="http://www.haocw.com/js/6.js"></script></div>
