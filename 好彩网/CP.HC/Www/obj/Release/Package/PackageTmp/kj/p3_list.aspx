<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p3_list.aspx.cs" Inherits="Www.kj.p3_list" %>
...
<div class="w1200" >
	...
	<div id="kaij2">
		...
		<div class="lin p12">        	
			...
			<div class="w5"><a href="/kj/p3/<%#DataBinder.Eval(Container.DataItem,"qi")%>.html"><img src="/image/xiangqing.jpg" alt="详情"  border="0"/></a></div>
		</div>
