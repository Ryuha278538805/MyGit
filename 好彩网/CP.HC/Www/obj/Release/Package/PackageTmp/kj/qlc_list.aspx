<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qlc_list.aspx.cs" Inherits="Www.kj.qlc_list" %>
	...
	<div id="kaij2">
		...
		<div class="lin p12">        	
			...
			<div class="w2">
                 ...
                 <div class="blue"><%#DataBinder.Eval(Container.DataItem,"h")%></div>
			</div>
			...
			<div class="w4"><%#DataBinder.Eval(Container.DataItem,"zj2")%></div>
			...
			<div class="w4"><%#GetNumStr(DataBinder.Eval(Container.DataItem,"zj4").ToString())%></div>
			<div class="w3"><%#GetDateStr(DataBinder.Eval(Container.DataItem,"date"))%></div>
			<div class="w5"><a href="/kj/qlc/<%#DataBinder.Eval(Container.DataItem,"qi")%>.html"><img src="/image/xiangqing.jpg" alt="详情"  border="0"/></a></div>
		</div>
