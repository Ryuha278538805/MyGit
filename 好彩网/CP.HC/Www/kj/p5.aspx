<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p5.aspx.cs" Inherits="Www.kj.p5" %>
...
<title>体彩排列五开奖号第<%=info.qi%>期</title>
...
<div class="w1200" >
  ...
  <tr>
    <td height="40" colspan="2" align="center" bgcolor="#FFFFFF"><h1>体彩排列五 第<span class="redtext"><%=info.qi%></span>期开奖结果</h1></td>
  ...
  <tr>
    <td width="213" height="38" align="right" bgcolor="#FFFFFF">体彩排列五第
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><div class="kj"><%=GetNumStr(info.zjp5)%> 注 每注 <span class="redtext"><%=GetNumStr("100000")%></span>元</div></td>
  </tr>
  <tr>
    <td height="38" align="right" bgcolor="#FFFFFF">投注金额：</td>
    <td bgcolor="#FFFFFF"><div class="kj"><%=GetNumStr(info.tzmoneyp5)%> 元</div></td>
  </tr>
</table>
	</div>
</div>
