...
namespace Www.kj
{
    public partial class qxc : Pages
    {
        protected int qi;
        protected KjhQxcInfo info = new KjhQxcInfo();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (qi > 0)
                info = KjhQxc.GetKjhQxcInfo(0, qi, true);

            List<KjhQxcInfo> listkjh = KjhQxc.GetKjhQxcPageList(10, 1, 0, true);
