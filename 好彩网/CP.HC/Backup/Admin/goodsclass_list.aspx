<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goodsclass_list.aspx.cs" Inherits="Admin.goodsclass_list" %>
...
<div id="main-content"> <!-- Main Content Section with everything -->
				...
				<div class="content-box-header">
				  ...
				  <h3>列表框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">社区商店商品分类列表</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
                                ...
                                <tfoot>
                                  <tr>
                                    ...
                                    <div class="bulk-actions align-left">
                                      ...
                                      <a class="button" href="javascript:void(0);" onclick="delall(8);">确认</a>	
                                 </div>
    ...
    PrevPageText="上一页" ShowInputBox="Never" onpagechanged="AspNetPager1_PageChanged">
                                ...
                                <tbody>
                                  ...
                                  <itemtemplate>
                                  <tr>
                                    <td><input type="checkbox" name="ids" value="<%#DataBinder.Eval(Container.DataItem,"gcid").ToString().Trim()%>"/></td>
                                    <td><a href="#"><%#DataBinder.Eval(Container.DataItem,"name").ToString().Trim()%></a></td>
                                    <td><%#DataBinder.Eval(Container.DataItem,"orderint").ToString().Trim()%></td>
                                    <td><!-- Icons -->
                                      <a href="?gcid=<%#DataBinder.Eval(Container.DataItem,"gcid")%>" title="编辑"><img src="resources/images/icons/pencil.png" alt="编辑" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
									  <a href="javascript:void(0);" onclick="del(8,<%#DataBinder.Eval(Container.DataItem,"gcid")%>);" title="删除"><img src="resources/images/icons/cross.png" alt="删除" /></a> 
                                    </td>
                                  </tr>
                                  </itemtemplate>
                                  </asp:Repeater>
            ...
            <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>添加/编辑框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">社区商店商品分类添加</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
                                ...
                                <tbody>
                                 <tr>
                                  ...
                                  <tr>
                                    <td><p>
                                      <label>排序*</label></p></td>
                                    <td><asp:TextBox ID="orderint" runat="server" CssClass="text-input" Width="100px"></asp:TextBox></td>
                                    <td><span class="tip">(排序)</span></td>
                                 </tr>
                                </tbody>
                              </table>
						    </div>
