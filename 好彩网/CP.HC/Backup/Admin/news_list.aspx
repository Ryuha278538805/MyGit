<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_list.aspx.cs" Inherits="Admin.news_list" %>
				...
				<div class="content-box-header">
				  ...
				  <h3>列表框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">资讯列表</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
							  ...
							  <table>
							    <thead>
							      <tr>
							        ...
							        <th width="30%">
                            	<asp:DropDownList ID="cid" runat="server" CssClass="select" AutoPostBack="True" onselectedindexchanged="cid_SelectedIndexChanged"><asp:ListItem Text="==请选择分类==" Value="0"></asp:ListItem></asp:DropDownList>资讯标题</th>
							        <th width="14%">彩种/期数</th>
							        <th width="12%">专题</th>
                                    <th width="8%">作者</th>
                                    <th width="5%">点击</th>
                                    <th width="5%">置顶</th>
							    ...
							    <tfoot>
							      <tr>
							        <td colspan="10"><div class="bulk-actions align-left">
							          ...
							          <a class="button" href="javascript:void(0);" onclick="delall(4);">确认</a> </div>
    ...
    PrevPageText="上一页" ShowInputBox="Never" onpagechanged="AspNetPager1_PageChanged"> </webdiyer:AspNetPager>
							    ...
							    <tbody>
							      <asp:Repeater ID="list" runat="server" EnableViewState="true">
							        <itemtemplate>
							          <tr>
							            <td><input type="checkbox" name="ids" value="<%#DataBinder.Eval(Container.DataItem,"nid").ToString().Trim()%>"/></td>
							            <td>【<a href="?cid=<%#DataBinder.Eval(Container.DataItem,"cid")%>"><%#GetCname(DataBinder.Eval(Container.DataItem,"cid"))%></a>】<a href="http://www.haocw.com/news/news_info.aspx?nid=<%#DataBinder.Eval(Container.DataItem,"nid").ToString().Trim()%>" target="_blank" style="color:<%#DataBinder.Eval(Container.DataItem,"color").ToString().Trim()%>"><%#DataBinder.Eval(Container.DataItem,"title").ToString().Trim()%></a></td>
							            <td><%#GetQi(DataBinder.Eval(Container.DataItem,"qi"))%><%#GetCzname(DataBinder.Eval(Container.DataItem,"czid"))%></td>
							            <td><%#GetZonename(DataBinder.Eval(Container.DataItem,"zid"))%></td>
                                        <td><%#DataBinder.Eval(Container.DataItem,"anthor").ToString().Trim()%></td>
                                        <td><%#GetHits(DataBinder.Eval(Container.DataItem,"nid"))%></td>
							            ...
							            <td><!-- Icons -->
							              <a href="news_add.aspx?nid=<%#DataBinder.Eval(Container.DataItem,"nid")%>" title="编辑"><img src="resources/images/icons/pencil.png" alt="编辑" /></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" onclick="del(4,<%#DataBinder.Eval(Container.DataItem,"nid")%>);" title="删除"><img src="resources/images/icons/cross.png" alt="删除" /></a></td>
						              </tr>
						            </itemtemplate>
						          </asp:Repeater>
						        </tbody>
