<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lottery_qlc.aspx.cs" Inherits="Admin.lottery_qlc" %>
		...
		<h2>添加/编辑七乐彩开奖号
		 <asp:Button ID="autoget2" Text=" 更新最后开奖号 "  CssClass="button" runat="server" OnClick="autoget2_Click"/>               
            ...
            <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>添加/编辑框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">七乐彩开奖号添加/编辑</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
              ...
              <asp:TextBox ID="g" runat="server" CssClass="text-input" Width="20px"></asp:TextBox>
              <asp:TextBox ID="h" runat="server" CssClass="text-input" Width="20px"></asp:TextBox></td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    特等：
                                      <asp:TextBox ID="zjt" runat="server" CssClass="text-input" Width="20px"></asp:TextBox>
                                      一等：
                                      ...
                                      七等：
                                      <asp:TextBox ID="zj7" runat="server" CssClass="text-input" Width="100px"></asp:TextBox></td>
                                   ...
                                   <tr>
                                    ...
                                    <td>特等：
                                      <asp:TextBox ID="jot" runat="server" CssClass="text-input" Width="100px"></asp:TextBox>
                                        一等：
	  ...
	  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>列表框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">七乐彩开奖号</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
							      ...
							      <asp:Repeater ID="list" runat="server" EnableViewState="true">
							        <itemtemplate>
							          <tr>
							            ...
							            <td><span class="red"><%#GetKjh(DataBinder.Eval(Container.DataItem,"a"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"b"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"c"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"d"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"e"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"f"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"g"))%></span>&nbsp;&nbsp;|&nbsp;&nbsp;<span class="blue"><%#GetKjh(DataBinder.Eval(Container.DataItem,"h"))%></span></td>
...
<div id="footer">
				<small> <!-- Remove this notice or replace it with whatever you want -->
						&#169; Copyright 2012  | Powered by <a href="http://www.haocw.com/">haocw.comm</a> | <a href="#">Top</a>
				</small>
		  </div><!-- End #footer -->
