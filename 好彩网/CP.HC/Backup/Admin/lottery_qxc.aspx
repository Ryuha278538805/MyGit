<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lottery_qxc.aspx.cs" Inherits="Admin.lottery_qxc" %>
            ...
            <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>添加/编辑框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">七星彩开奖号添加/编辑</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
              ...
              <asp:TextBox ID="g" runat="server" CssClass="text-input" Width="20px"></asp:TextBox></td>
                                  ...
                                  <tr>
                                    ...
                                    <td>特等：
                                      <asp:TextBox ID="zjt" runat="server" CssClass="text-input" Width="100px"></asp:TextBox>
一等：
	  ...
	  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>列表框   				    </h3>
					...
					<ul class="content-box-tabs">
					  <li><a href="#tab1" class="default-tab">七星彩开奖号</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
							      ...
							      <asp:Repeater ID="list" runat="server" EnableViewState="true">
							        <itemtemplate>
							          <tr>
                                        ...
                                        <td><%#DataBinder.Eval(Container.DataItem,"zjt")%> 注 &nbsp;【<%#DataBinder.Eval(Container.DataItem,"jot")%>】</td>
