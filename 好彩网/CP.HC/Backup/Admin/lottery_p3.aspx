<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lottery_p3.aspx.cs" Inherits="Admin.lottery_p3" %>
		...
		<h2>添加/编辑体彩P3/P5开奖号
		  <asp:Button ID="autoget2" Text=" 更新最后开奖号 "  CssClass="button" runat="server" OnClick="autoget2_Click"/>               
            ...
            <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>添加/编辑框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">体彩P3/P5开奖号添加/编辑</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
              ...
              <asp:TextBox ID="c" runat="server" CssClass="text-input" Width="20px"></asp:TextBox>
              <asp:TextBox ID="d" runat="server" CssClass="text-input" Width="20px"></asp:TextBox>
                                  ...
                                  <tr>
                                    ...
                                    <td>直选：
                                      ...
                                      组三：
                                       ...
                                       组六：
                                       <asp:TextBox ID="zj3" runat="server" CssClass="text-input" Width="100px"></asp:TextBox> 
                                       排列五：
                                       <asp:TextBox ID="zjp5" runat="server" CssClass="text-input" Width="100px"></asp:TextBox></td>
                                    <td><span class="tip">(依次为直选，组3，组6,排列5)</span></td>
                                  </tr>
                                   <tr>
                                    <td><p>
                                      <label>投注额</label></p></td>
                                    <td>P3：
                                      <asp:TextBox ID="tzmoney" runat="server" CssClass="text-input" Width="220px"></asp:TextBox> 
                                      P5：
                                      <asp:TextBox ID="tzmoneyp5" runat="server" CssClass="text-input" Width="220px"></asp:TextBox></td>
                                    <td><span class="tip">(投注额)</span></td>
                                  </tr>
                                   <tr>
                                    <td><p>
	  ...
	  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
				  ...
				  <h3>列表框</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">体彩P3/P5开奖号</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
							  ...
							  <table>
							    <thead>
							      <tr>
							        ...
							        <th width="13%">期号</th>
							        <th width="16%">开奖号</th>
                                    <th width="22%">投注额P3/P5</th>
							        <th width="22%"><span class="tip">直选/组3/组6/P5</span></th>
                                    <th width="14%">开奖日期</th>
							        <th width="10%">操作</th>
						          </tr>
						        </thead>
							      ...
							      <asp:Repeater ID="list" runat="server" EnableViewState="true">
							        <itemtemplate>
							          <tr>
							            ...
							            <td class="red"><%#GetKjh(DataBinder.Eval(Container.DataItem,"a"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"b"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"c"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"d"))%>,&nbsp;<%#GetKjh(DataBinder.Eval(Container.DataItem,"e"))%></td>
                                        <td><%#DataBinder.Eval(Container.DataItem,"tzmoney").ToString().Trim()%>  / <%#DataBinder.Eval(Container.DataItem,"tzmoneyp5").ToString().Trim()%></td>
                                        <td><%#DataBinder.Eval(Container.DataItem,"zj1").ToString().Trim()%> / <%#DataBinder.Eval(Container.DataItem,"zj2").ToString().Trim()%> / <%#DataBinder.Eval(Container.DataItem,"zj3").ToString().Trim()%> / <%#DataBinder.Eval(Container.DataItem,"zjp5").ToString().Trim()%></td>
