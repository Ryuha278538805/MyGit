<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="225_list.aspx.cs" Inherits="Www.kj._225_list" %>
...
<div class="w1200" >
	<div id="kaij2">
		...
		<div class="lin p12">        	
			...
			<div class="w4"><%#GetNumStr(DataBinder.Eval(Container.DataItem,"prize1").ToString())%></div>
			<div class="w4"><%#DataBinder.Eval(Container.DataItem,"zj2")%></div>
			<div class="w4"><%#DataBinder.Eval(Container.DataItem,"prize2")%></div>
			<div class="w4"><%#GetNumStr(DataBinder.Eval(Container.DataItem,"zj3").ToString())%></div>
			<div class="w4"><%#DataBinder.Eval(Container.DataItem,"prize3")%></div>
			<div class="w3"><%#GetDateStr(DataBinder.Eval(Container.DataItem,"date"))%></div>
			<div class="w5"><a href="/kj/225/<%#DataBinder.Eval(Container.DataItem,"qi")%>.html"><img src="/image/xiangqing.jpg" alt="详情" border="0"/></a></div>
		</div>
