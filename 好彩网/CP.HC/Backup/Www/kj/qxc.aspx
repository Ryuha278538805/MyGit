<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qxc.aspx.cs" Inherits="Www.kj.qxc" %>
...
<title>七星彩第<%=info.qi%>期开奖结果</title>
...
<div class="w1200" >
  ...
  <tr>
    <td height="40" colspan="2" align="center" bgcolor="#FFFFFF"><h1>七星彩 第<span class="redtext"><%=info.qi%></span>期开奖结果</h1></td>
  ...
  <tr>
    <td width="213" height="38" align="right" bgcolor="#FFFFFF">七星彩第
	...
	<div class="kj p12">
		 ...
		 <div class="red"><%=info.d%></div>
         <div class="red"><%=info.e%></div>
         <div class="red"><%=info.f%></div>
         <div class="red"><%=info.g%></div>
	</div>	</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><div class="kj"><%=GetNumStr(info.zj3)%> 注 每注 <span class="redtext">300</span>元</div></td>
  </tr>
  <tr>
    <td height="38" align="right" bgcolor="#FFFFFF">五等奖：</td>
    <td bgcolor="#FFFFFF"><span class="kj"><%=GetNumStr(info.zj4)%> 注 每注 <span class="redtext">20</span>元</span></td>
  </tr>
  <tr>
    <td height="38" align="right" bgcolor="#FFFFFF">六等奖：</td>
    <td bgcolor="#FFFFFF"><span class="kj"><%=GetNumStr(info.zj5)%> 注 每注 <span class="redtext">5</span>元</span></td>
  </tr>
  <tr>
