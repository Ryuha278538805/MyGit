<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qxc_list.aspx.cs" Inherits="Www.kj.qxc_list" %>
...
<div class="w1200" >
	<div id="kaij2">
		...
		<div class="top p14">
			...
			<div class="w4">三等奖</div>
			<div class="w4">三等奖金</div>
		...
		<div class="lin p12">        	
			...
			<div class="w2">
                 ...
                 <div class="red"><%#DataBinder.Eval(Container.DataItem,"f")%></div>
                 <div class="red"><%#DataBinder.Eval(Container.DataItem,"g")%></div>
			</div>
			<div class="w3"><%#GetNumStr(DataBinder.Eval(Container.DataItem,"tzmoney").ToString())%></div>
			<div class="w4"><%#DataBinder.Eval(Container.DataItem,"zjt")%></div>
			<div class="w4"><%#GetNumStr(DataBinder.Eval(Container.DataItem,"jot").ToString())%></div>
			...
			<div class="w4"><%#DataBinder.Eval(Container.DataItem,"zj2").ToString()%></div>
			...
			<div class="w5"><a href="/kj/qxc/<%#DataBinder.Eval(Container.DataItem,"qi")%>.html"><img src="/image/xiangqing.jpg" alt="详情"  border="0"/></a></div>
		</div>
