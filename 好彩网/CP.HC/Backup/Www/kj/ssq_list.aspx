<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ssq_list.aspx.cs" Inherits="Www.kj.ssq_list" %>
	...
	<div id="kaij2">
		...
		<div class="lin p12">        	
			...
			<div class="w2">
                 ...
                 <div class="blue"><%#DataBinder.Eval(Container.DataItem,"g")%></div>
			</div>
			...
			<div class="w5"><a href="/kj/ssq/<%#DataBinder.Eval(Container.DataItem,"qi")%>.html"><img src="/image/xiangqing.jpg" alt="详情"  border="0"/></a></div>
		</div>
