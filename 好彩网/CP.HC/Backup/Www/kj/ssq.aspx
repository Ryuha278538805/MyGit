<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ssq.aspx.cs" Inherits="Www.kj.ssq" %>
...
<title>双色球第<%=info.qi%>期开奖结果</title>
...
<div class="w1200" >
  ...
  <tr>
    <td height="40" colspan="2" align="center" bgcolor="#FFFFFF"><h1>双色球 第<span class="redtext"><%=info.qi%></span>期开奖结果</h1></td>
    <td width="208" height="300" rowspan="10" valign="top" bgcolor="#FFFFFF">
    
    	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
		  <tr>
			<td width="65%" height="35" align="center" bgcolor="#FFFFFF"><span style="font-size:14px; font-weight:bold">最新双色球论坛贴</span></td>
			<td width="35%" align="center" bgcolor="#FFFFFF"><span class="gd"><a href="http://bbs.haocw.com/showforum-7.aspx" target="_blank">进入论坛</a></span></td>
		  </tr>
  ...
  <tr>
    <td width="213" height="38" align="right" bgcolor="#FFFFFF">双色球第
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><span class="kj"><%=GetNumStr(info.zj5)%> 注 每注 <span class="redtext">10</span>元</span></td>
  </tr>
  <tr>
    <td height="38" align="right" bgcolor="#FFFFFF">六等奖：</td>
    <td bgcolor="#FFFFFF"><span class="kj"><%=GetNumStr(info.zj6)%> 注 每注 <span class="redtext">5</span>元</span></td>
  </tr>
  <tr>
