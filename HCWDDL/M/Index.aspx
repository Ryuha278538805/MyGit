<%@ Page Title="" Language="C#" MasterPageFile="Index.master" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="M_Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <section class="tabContainer">
        <div class="con kjList bg-fff active">
            <a class="ticket ub ub-ac" href="award_ssq.html?id=<%=SSQInfo.id %>">
                <div class="ub-f1 mr-10">
                    ...
                    <div class="ub ub-ac">
                        <div class="ballBox">
                            <span class="ball red"><%=SSQInfo.a.HasValue? SSQInfo.a.Value.ToString().PadRight(2,'0'):"" %></span>
                            <span class="ball red"><%=SSQInfo.b.HasValue? SSQInfo.b.Value.ToString().PadRight(2,'0'):"" %></span>
                            <span class="ball red"><%=SSQInfo.c.HasValue? SSQInfo.c.Value.ToString().PadRight(2,'0'):"" %></span>
                            <span class="ball red"><%=SSQInfo.d.HasValue? SSQInfo.d.Value.ToString().PadRight(2,'0'):"" %></span>
                            <span class="ball red"><%=SSQInfo.e.HasValue? SSQInfo.e.Value.ToString().PadRight(2,'0'):"" %></span>
                            <span class="ball red"><%=SSQInfo.f.HasValue? SSQInfo.f.Value.ToString().PadRight(2,'0'):"" %></span>
                            <span class="ball blue"><%=SSQInfo.g.HasValue? SSQInfo.g.Value.ToString().PadRight(2,'0'):"" %></span>
                        </div>
                    </div>
            ...
            <a class="ticket ub ub-ac" href="award_3d.html?id=<%=SDInfo.id %>">
                <div class="ub-f1 mr-10">
