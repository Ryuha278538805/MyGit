<%@ Page Title="" Language="C#" MasterPageFile="~/M/Index.Master" AutoEventWireup="true" CodeBehind="award_ssq.aspx.cs" Inherits="HCWDDL.M.awarddetail.award_ssq" %>
        ...
        <div class="content">
            ...
            <div class="chooseQi clearfix">
                <%foreach (var qi in DIC_QI)
                  { %>
                <div class="con">
                    <a target="_self" href="award_ssq.aspx?id=<%=qi.id %>"><%=qi.qi %></a>
                </div>
                <%} %>
            </div>
        </div>
            ...
            <div class="ticket">
                <div>
                    <div class="name ub ub-ac">
                        <div class="ub-f1">
                            <b class="text-16 mr-10">双色球 <%=Model.qi.HasValue?Model.qi.Value.ToString().Substring(4,3):"" %> 期开奖</b>
                    ...
                    <div class="ub ub-ac">
                        <div class="ballBox ub-f1">
                            <span class="ball red"><%=Model.a.HasValue? Model.a.Value.ToString().PadLeft(2,'0'):"" %></span>
                            <span class="ball red"><%=Model.b.HasValue? Model.b.Value.ToString().PadLeft(2,'0'):"" %></span>
                            <span class="ball red"><%=Model.c.HasValue? Model.c.Value.ToString().PadLeft(2,'0'):"" %></span>
                            <span class="ball red"><%=Model.d.HasValue? Model.d.Value.ToString().PadLeft(2,'0'):"" %></span>
                            <span class="ball red"><%=Model.e.HasValue? Model.e.Value.ToString().PadLeft(2,'0'):"" %></span>
                            <span class="ball red"><%=Model.f.HasValue? Model.f.Value.ToString().PadLeft(2,'0'):"" %></span>
                            <span class="ball blue"><%=Model.g.HasValue? Model.g.Value.ToString().PadLeft(2,'0'):"" %></span>
                        </div>
                    </div>
